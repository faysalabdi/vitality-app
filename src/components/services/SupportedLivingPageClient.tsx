        ...
        <section className="py-16 bg-white">
           <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-slate-800 mb-6">Live Independently with the Right Support</h2>
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 text-center md:text-left">
                    <div className="inline-flex items-center justify-center md:justify-start mb-4">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-slate-800" style={{ textShadow: '0px 1px 2px rgba(0,0,0,0.1)' }}>{service.title}</h3>
                    </div>
                    <p className="text-gray-900 mb-6 mx-auto md:mx-0 max-w-md">{service.longDescription}</p>
                    <Link
                      href="/contact-us#contact-form"
                      className="inline-flex items-center font-medium px-4 py-2 border-2 rounded-md transition-all hover:bg-opacity-90 hover:shadow-md"
                      style={{ 
                        color: 'white', 
        ...
        <section className="py-16 bg-white">
           <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center text-slate-800 mb-8">Why Choose Vitality for Supported Living</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Feature 1 - Adjust padding */}
                <AnimatedSection variantType="zoomIn" delay={0.1}><div className={`bg-[${lightBgColor}] px-6 py-6 rounded-lg shadow-md transition-transform duration-300 hover:-translate-y-2 h-full flex flex-col items-center justify-center`} style={{ borderTop: `4px solid ${primaryColor}` }}> <div className={`w-10 h-10 rounded-full bg-[${primaryColor}]/10 flex items-center justify-center mb-2`}><svg className={`w-5 h-5 text-[${primaryColor}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg></div> <div className="text-3xl mb-1">👤</div> <h3 className="text-xl font-semibold text-slate-800 mb-1 text-center">Person-Centred Approach</h3> <p className="text-gray-900 text-center">Your goals and choices are at the heart of everything we do.</p> </div></AnimatedSection>
                {/* Feature 2 - Adjust padding */}
                <AnimatedSection variantType="zoomIn" delay={0.2}><div className={`bg-[${lightBgColor}] px-6 py-6 rounded-lg shadow-md transition-transform duration-300 hover:-translate-y-2 h-full flex flex-col items-center justify-center`} style={{ borderTop: `4px solid ${secondaryColor}` }}> <div className={`w-10 h-10 rounded-full bg-[${secondaryColor}]/10 flex items-center justify-center mb-2`}><svg className={`w-5 h-5 text-[${secondaryColor}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></div> <div className="text-3xl mb-1">🤝</div> <h3 className="text-xl font-semibold text-slate-800 mb-1 text-center">Experienced Support Team</h3> <p className="text-gray-900 text-center">Our qualified staff are passionate about supporting independence.</p> </div></AnimatedSection>
                {/* Feature 3 - Adjust padding */}
                <AnimatedSection variantType="zoomIn" delay={0.1}><div className={`bg-[${lightBgColor}] px-6 py-6 rounded-lg shadow-md transition-transform duration-300 hover:-translate-y-2 h-full flex flex-col items-center justify-center`} style={{ borderTop: `4px solid ${accentColor}` }}> <div className={`w-10 h-10 rounded-full bg-[${accentColor}]/10 flex items-center justify-center mb-2`}><svg className={`w-5 h-5 text-[${accentColor}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg></div> <div className="text-3xl mb-1">🏠</div> <h3 className="text-xl font-semibold text-slate-800 mb-1 text-center">Safe & Supportive Homes</h3> <p className="text-gray-900 text-center">We provide comfortable and accessible living environments.</p> </div></AnimatedSection>
                {/* Feature 4 - Adjust padding */}
                <AnimatedSection variantType="zoomIn" delay={0.2}><div className={`bg-[${lightBgColor}] px-6 py-6 rounded-lg shadow-md transition-transform duration-300 hover:-translate-y-2 h-full flex flex-col items-center justify-center`} style={{ borderTop: `4px solid ${primaryColor}` }}> <div className={`w-10 h-10 rounded-full bg-[${primaryColor}]/10 flex items-center justify-center mb-2`}><svg className={`w-5 h-5 text-[${primaryColor}]`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg></div> <div className="text-3xl mb-1">🧠</div> <h3 className="text-xl font-semibold text-slate-800 mb-1 text-center">Focus on Skill Building</h3> <p className="text-gray-900 text-center">We help you develop the skills needed for greater autonomy.</p> </div></AnimatedSection>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className={`py-8 bg-[${lightBgColor}]`}>
         <div className="container mx-auto px-4">
          <div className="flex justify-center">
            <Link href="/services"
              className="inline-flex items-center px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50 hover:shadow-md transition duration-300">
