        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/referral" className="text-gray-300 hover:text-white transition">
                  Make a Referral
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/ndis" className="text-gray-300 hover:text-white transition">
                  NDIS
                </Link>
              </li>
              <li>
                <Link href="/ndis/accommodation" className="text-gray-300 hover:text-white transition">
                  Accommodation
                </Link>
              </li>
              <li>
                <Link href="/aged-care" className="text-gray-300 hover:text-white transition">
                  Aged Care
                </Link>
              </li>
              <li>
                <Link href="/allied-health" className="text-gray-300 hover:text-white transition">
                  Allied Health
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:1300395852" className="text-gray-300 hover:text-white transition">
                  1300 395 852
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:contact@vitalitycommunitycare.com.au" className="text-gray-300 hover:text-white transition">
